...
describe('Problem 03 - transformObservation(), transformObservations(), transformObservations2() functions', function () {
  describe('transformObservation() function', function () {
    ...
    test('should return an Object containing a photos Array of URLs', function () {
      ...
      expect(result.photosCount).toBe(result.photos.length);
      ...
      expect(transformObservations(data)).toEqual([
        {
          ...
          photos: ['https://static.inaturalist.org/photos/109762131/square.jpg?1610308133'],
          photosCount: 1,
        ...
        },
        {
          ...
          photos: ['https://static.inaturalist.org/photos/107267018/square.jpeg?1607882195'],
          photosCount: 1,
        ...
        },
        {
          ...
          id: 61770700,
          isResearchQuality: true,
          photos: ['https://static.inaturalist.org/photos/98884441/square.jpg?1601901356'],
          photosCount: 1,
        ...
        },
        {
          ...
          id: 61472666,
          isResearchQuality: false,
          photos: ['https://static.inaturalist.org/photos/98374594/square.jpeg?1601643792'],
          photosCount: 1,
        ...
        },
        {
          ...
          id: 60706122,
          isResearchQuality: true,
          photos: ['https://static.inaturalist.org/photos/97090180/square.jpeg?1601038974'],
          photosCount: 1,
        ...
        },
        {
          ...
          id: 60671346,
          isResearchQuality: true,
          photos: ['https://static.inaturalist.org/photos/97031452/square.jpeg?1600996784'],
          photosCount: 1,
        ...
        },
        {
          ...
          id: 60020978,
          isResearchQuality: false,
          photos: ['https://static.inaturalist.org/photos/95944070/square.jpeg?1600471140'],
          photosCount: 1,
          speciesGuess: '矮牽牛屬',
          user: '@xinjielin'
        },
